...
public class MissilePowerUp extends PowerUp{
    ...
    private void setup(){
        try {
            ...
            URL missileFiredPath = this.getClass().getResource("/images/missileFired.png");
    ...
    protected void Draw(Graphics2D g2d) {
        if(!wasUsed) {
            ...
            g2d.drawImage(missileFiredImage, xPos, yPos, missileFiredWidth, missileFiredHeight, null);
        }
    }
